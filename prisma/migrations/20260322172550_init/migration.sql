...
CREATE TABLE "mediations" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "mediations_lease_id_fkey" FOREIGN KEY ("lease_id") REFERENCES "leases" ("lease_id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "fiscal_dossiers" (
    ...
    "taux_applique" DECIMAL NOT NULL DEFAULT 0.0250,
...
CREATE TABLE "pgw_reconciliation" (
    ...
    "montant_total_qapril" DECIMAL NOT NULL,
    "montant_total_operateur" DECIMAL,
...
CREATE TABLE "tickets_maintenance" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "closed_at" DATETIME,
    CONSTRAINT "tickets_maintenance_unite_id_fkey" FOREIGN KEY ("unite_id") REFERENCES "properties" ("property_id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "tickets_maintenance_lease_id_fkey" FOREIGN KEY ("lease_id") REFERENCES "leases" ("lease_id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "tickets_maintenance_declarant_id_fkey" FOREIGN KEY ("declarant_id") REFERENCES "users" ("user_id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE "regularisations_charges" (
    ...
    "provisions_collectees" DECIMAL NOT NULL,
    "charges_reelles" DECIMAL NOT NULL,
...
CREATE TABLE "annonces" (
    ...
    "titre" TEXT NOT NULL,
    "description" TEXT NOT NULL,
    "loyer_demande" DECIMAL NOT NULL,
    "charges" DECIMAL NOT NULL DEFAULT 0,
    "photos_urls" JSONB NOT NULL,
    "criteres" JSONB,
...
CREATE TABLE "crg_mensuel" (
    ...
    "loyers_encaisses" DECIMAL NOT NULL DEFAULT 0,
    "charges_deduites" DECIMAL NOT NULL DEFAULT 0,
    "travaux_deduits" DECIMAL NOT NULL DEFAULT 0,
    "honoraires_agence" DECIMAL NOT NULL DEFAULT 0,
    "reversement_net" DECIMAL NOT NULL,
...
CREATE TABLE "tva_transactions" (
    ...
    "taux_tva" DECIMAL NOT NULL DEFAULT 18.00,
...
CREATE TABLE "bails_declaratifs" (
    ...
    "adresse_libre" TEXT,
    "loyer_declare_mensuel" DECIMAL NOT NULL,
    ...
    "contre_proposition_loyer" DECIMAL,
    "motif_refus" TEXT,
...
CREATE TABLE "bdq_historique_loyer" (
    ...
    "bdq_id" TEXT NOT NULL,
    "ancien_loyer" DECIMAL NOT NULL,
    "nouveau_loyer" DECIMAL NOT NULL,
    "motif" TEXT,
    "confirmation_locataire" BOOLEAN,
    "modifie_par" TEXT,
...
CREATE TABLE "bdq_conversation_states" (
    ...
    "cout_estime_fcfa" DECIMAL NOT NULL DEFAULT 0,
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    "expire_at" DATETIME,
    "completed_at" DATETIME,
...
CREATE TABLE "notification_preferences" (
    ...
    "evenements_actifs" JSONB DEFAULT {"QUITTANCE_GENEREE": ["wa","sms","email"], "PAIEMENT_RECU": ["wa","sms"], "IMPAYE_DETECTE": ["wa","sms"], "BAIL_CONFIRME": ["wa","sms","email"], "RAPPORT_MENSUEL": ["wa","email"], "WALLET_BAS": ["wa","sms"], "BAIL_EXPIRANT": ["wa","sms"]},
...
CREATE TABLE "sms_declarations" (
    ...
    "montant_declare" DECIMAL NOT NULL,
...
CREATE TABLE "offres_abonnements" (
    ...
    "description" TEXT,
    "prix_base_ttc" DECIMAL NOT NULL,
    "quittances_inclus" INTEGER NOT NULL DEFAULT 0,
    "prix_unite_ttc" DECIMAL DEFAULT 0,
...
CREATE TABLE "codes_promo" (
    ...
    "valeur_remise" DECIMAL NOT NULL,
    "offre_cible" TEXT,
...
CREATE TABLE "tarifs_negocie" (
    ...
    "type" TEXT NOT NULL,
    "offre_id" TEXT,
    "prix_negocie_ttc" DECIMAL NOT NULL,
    "date_debut" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "date_fin" DATETIME,
...
CREATE TABLE "locataire_profiles" (
    ...
    "taux_paiement_12m" DECIMAL NOT NULL DEFAULT 0,
...
CREATE TABLE "passeports_locatifs" (
    ...
    "taux_paiement_global" DECIMAL NOT NULL,
...
CREATE TABLE "locataire_profils_publics" (
    ...
    "employeur_type" TEXT,
    "communes_souhaitees" JSONB DEFAULT [],
    "budget_max_fcfa" INTEGER,
    "type_logement" JSONB DEFAULT [],
...
CREATE TABLE "champions_profiles" (
    ...
    "total_commissions_fcfa" DECIMAL NOT NULL DEFAULT 0,
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
