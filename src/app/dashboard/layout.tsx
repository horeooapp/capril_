                        ...
                        <div className="flex items-center">
                            <Link href="/dashboard" className="flex items-center space-x-4 group">
                                <ProtectedLogo 
                                    src="/logo.png" 
                                    alt="QAPRIL Logo" 
                                    className="h-16 w-auto border border-white/20 rounded shadow-sm group-hover:scale-105 transition-transform" 
                                />
                                <span className="font-bold text-2xl hidden sm:inline">QAPRIL <span className="text-sm font-normal text-orange-200">| Portail Gestionnaire</span></span>
                            </Link>
                        </div>
