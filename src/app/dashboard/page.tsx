...
export default async function DashboardOverview() {
    try {
        ...
        properties.forEach((p: any) => {
            p.leases?.forEach((l: any) => {
                if (l.receipts) {
                    receiptsThisMonth += l.receipts.filter((r: any) => r.paymentDate && new Date(r.paymentDate) >= startOfMonth).length
                }
            })
        })
        ...
        return (
            <div className="p-8 bg-red-50 border border-red-200 rounded-lg">
                <h1 className="text-xl font-bold text-red-800">Erreur lors du chargement du tableau de bord</h1>
