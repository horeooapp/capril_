...
export default function StatCard({ title, value, icon: Icon, color, trend, delay = 0 }: StatCardProps) {
    ...
    return (
        <motion.div 
            ...
            whileHover={{ y: -5 }}
            className="glass-card-premium p-8 rounded-[2.5rem] relative overflow-hidden group transition-all duration-300"
        >
            ...
            {trend && (
                <motion.div 
                    ...
                    className="mt-8 pt-6 border-t border-gray-100/50 flex items-center gap-1.5 text-[10px] font-black text-green-600 uppercase tracking-widest"
                >
